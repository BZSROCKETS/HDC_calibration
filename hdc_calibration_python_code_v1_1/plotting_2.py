...
if __name__ == "__main__":
    ...
    while not terminate:
        ...
        if fig_name == "6.1a":
            ...
            plt.legend()
            plt.savefig("fig_6_2.pdf", bbox_inches='tight')
            plt.show()
            ...
            plt.plot(x_pos_itp, y_pos_itp, linewidth=2)
            plt.xlabel("x")
            plt.ylabel("y")
            plt.scatter(ref_points_x, ref_points_y, marker='o', s=40, color='gold')
            plt.scatter(ref_points_x, ref_points_y, marker='o', s=40, color='gold')
            ...
            plt.annotate('Start', xy=(1800, 500), fontsize=18)
            plt.annotate('End', xy=(2000, 700), fontsize=18)
            plt.annotate('Landmark', xy=(1550, 820), fontsize=18)
            plt.savefig("fig_6_7_a.pdf", bbox_inches='tight')
            plt.show()
            ...
            plt.xlabel("time (s)")
            plt.ylabel("angular velocity (deg/s)")
            plt.savefig("fig_6_7_b.pdf", bbox_inches='tight')
            plt.show()
            ...
            plt.xlabel("x")
            plt.ylabel("y")
            plt.scatter(ref_points_x, ref_points_y, marker='o', color='gold')
            plt.scatter(ref_points_x, ref_points_y, marker='o', color='gold')
            ...
            plt.annotate('Start', xy=(1870, 368), fontsize=18)
            plt.annotate('End', xy=(1900, 650), fontsize=18)
            plt.annotate('Landmark', xy=(1100, 340), fontsize=18)
            plt.savefig("fig_6_7_c.pdf", bbox_inches='tight')
            plt.show()
